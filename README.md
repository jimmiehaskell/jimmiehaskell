## Jimmie Haskell
<p>Aficionado por programação, sempre busquei aprender novas habilidades e entender como as coisas funcionam por trás da cortina, back-end. Atualmente estou focando meus estudos para o Python, Django e DRF, em paralelo PostgreSQL.</p>

<p>Corredor amador desde 2019, estou sempre buscando destrancar novas distancias, trainando para fazer a primeira maratona em 2026.</p>

<p> Sou formado em Análise e Desenvolvimento de Sistemas pela Cruzeiro do Sul, e iniciei a 2ª graduação em Engenharia de Software pela UDF, em Brasília/DF</p>
